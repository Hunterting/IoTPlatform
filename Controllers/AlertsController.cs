...
public class AlertsController : ControllerBase
{
    ...
    public async Task<ActionResult<ApiResponse<AlertDto>>> GetAlert(long id)
    {
        try
        {
            ...
            if (result == null)
            {
                return ApiResponse<AlertDto>.NotFound("告警不存在");
            }
        ...
        {
            return ApiResponse<AlertDto>.Error(ex.Message);
        }
    }
    ...
    public async Task<ActionResult<ApiResponse<AlertDto>>> CreateAlert([FromBody] CreateAlertRequest request)
    {
        ...
        {
            return ApiResponse<AlertDto>.BadRequest(ex.Message);
        }
        catch (Exception ex)
        {
            return ApiResponse<AlertDto>.Error(ex.Message);
        ...
        [FromQuery] DateTime? endTime = null)
    {
        ...
        {
            return ApiResponse<AlertSummaryDto>.Error(ex.Message);
        }
    }
